...
class CloudWalletAgent(DemoAgent):
    def __init__(
...
async def main(start_port: int, no_auto: bool = False, show_timing: bool = False):
    ...
    try:
        ...
        log_status("#9 ## Mushi changes here - 3")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Runs an CloudWallet demo agent.")
